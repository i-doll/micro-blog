...
const styles = stylex.create({
  ...
  dragOver: {
    ...
    background: 'color-mix(in srgb, var(--accent, #c05830) 5%, transparent)',
  },
  mediaBar: {
    display: 'flex',
    alignItems: 'center',
...
export function ComposePage() {
  ...
  const { data: mediaData, refetch: refetchMedia } = useMediaQuery();
  ...
  return (
    <div {...stylex.props(styles.compose)}>
      <h1 {...stylex.props(styles.pageTitle)}>New Story</h1>
      <SectionRule />
      ...
      <div {...stylex.props(styles.toolbar)}>
        ...
        <div {...stylex.props(styles.toolbarRight)}>
          <span {...stylex.props(styles.hint)}>Markdown supported</span>
          <select
